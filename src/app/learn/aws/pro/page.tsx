/**
 * AWS Professional コース カテゴリ一覧ページ
 * 
 * ルート: /learn/aws/pro
 * 
 * このページは、独自AWS試験（非公式） Professionalレベルの学習カテゴリ一覧を表示します。
 * 各カテゴリ（例：高度なアーキテクチャ設計、コスト最適化など）をクリックすると、そのカテゴリの学習ページに遷移します。
 */
...
export default function AWSProPage() {
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            より高度なAWSスキルを学び、実践的なアーキテクチャ設計能力を身につけます。
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <Link
              key={category.id}
              href={`/learn/aws/pro/${category.id}/study`}
