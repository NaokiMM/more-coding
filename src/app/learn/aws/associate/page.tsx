/**
 * AWS Associate コース カテゴリ一覧ページ
 * 
 * ルート: /learn/aws/associate
 * 
 * このページは、独自AWS試験（非公式） Associateレベルの学習カテゴリ一覧を表示します。
 * 各カテゴリ（例：クラウドの基礎、コンピューティングサービスなど）をクリックすると、そのカテゴリの学習ページに遷移します。
 */
...
export default function AWSAssociatePage() {
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            AWSの基礎を学びます。クラウドの基本概念から主要サービスまで、体系的に学習しましょう。
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <Link
              key={category.id}
              href={`/learn/aws/associate/${category.id}/study`}
