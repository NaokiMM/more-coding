 ...
 * 
 * このページは、Next.js Associateレベルの学習カテゴリ一覧を表示します。
 * 各カテゴリ（例：はじめに、ページとルーティングなど）をクリックすると、そのカテゴリの学習ページに遷移します。
 */
...
import { categoriesData } from "@/lib/categories/nextjs/associate-categories";

export default function NextJSAssociatePage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          <div className="mb-4 inline-flex h-20 w-20 items-center justify-center rounded-xl bg-gradient-to-br from-gray-700 to-gray-900 text-white text-3xl font-bold shadow-lg">
            🌱
          </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <Link
              key={category.id}
              href={`/learn/nextjs/associate/${category.id}/study`}
