/**
 * Nuxt.js Associate コース カテゴリ一覧ページ
 * 
 * ルート: /learn/nuxtjs/associate
 * 
 * このページは、Nuxt.js Associateレベルの学習カテゴリ一覧を表示します。
 * 各カテゴリ（例：基礎・レンダリング、データ取得・状態管理など）をクリックすると、そのカテゴリの学習ページに遷移します。
 */
...
export default function NuxtJSAssociatePage() {
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            Nuxt.jsの基礎を学びます。プロジェクトの作成から始めて、基本的な機能をマスターしましょう。
          </p>
          {/* Membership Badges */}
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <Link
              key={category.id}
              href={`/learn/nuxtjs/associate/${category.id}/study`}
