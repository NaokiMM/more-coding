/**
 * JavaScript Associate コース カテゴリ一覧ページ
 * 
 * ルート: /learn/javascript/associate
 * 
 * このページは、JavaScript Associateレベルの学習カテゴリ一覧を表示します。
 * 各カテゴリ（例：基礎表現、変数・スコープ・関数など）をクリックすると、そのカテゴリの学習ページに遷移します。
 */
...
export default function JavaScriptAssociatePage() {
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <Link
              key={category.id}
              href={`/learn/javascript/associate/${category.id}/study`}
