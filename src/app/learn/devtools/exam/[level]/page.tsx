/**
 * DevTools 本番試験 レベル別ページ
 * 
 * ルート: /learn/devtools/exam/[level]
 * 
 * このページは、DevTools本番試験の各レベル（associate, professional, expert）の
 * 模擬試験や過去問題演習を選択するページです。
 */

// src/app/learn/devtools/exam/[level]/page.tsx

import DevToolsExamLevelClient from "./Client";
...
export default async function Page({
  ...
  return <DevToolsExamLevelClient level={level} />;
}
