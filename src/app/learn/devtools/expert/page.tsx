/**
 * DevTools Expert カテゴリ一覧ページ
 *
 * ルート: /learn/devtools/expert
 */
...
export default function DevToolsExpertPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          <div className="mb-4 inline-flex h-20 w-20 items-center justify-center rounded-xl bg-gradient-to-br from-purple-600 to-pink-600 text-white text-3xl font-bold shadow-lg">
            🚀
          </div>
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            高度な機能とベストプラクティスを学び、効率的な開発ワークフローを構築します。
          </p>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <Link
              key={category.id}
              href={`/learn/devtools/expert/${category.id}/study`}
