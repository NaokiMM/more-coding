 ...
 * 
 * このページは、SEO Associateレベルの学習カテゴリ一覧を表示します。
 * 各カテゴリ（例：HTML構造・マークアップ最適化、メタ情報・クロール制御など）をクリックすると、そのカテゴリの学習ページに遷移します。
 */
...
export default function SEOAssociatePage() {
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <Link
              key={category.id}
              href={`/learn/seo/associate/${category.id}/study`}
