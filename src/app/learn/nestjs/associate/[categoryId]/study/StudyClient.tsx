...
const NESTJS_BASE = "/learn/nestjs";
const NESTJS_ASSOCIATE = "/learn/nestjs/associate";
          ...
          <div className="rounded-2xl bg-white p-8 shadow-lg dark:bg-slate-800">
            <div className="text-center">
              ...
              <div className="flex justify-center gap-4">
                ...
                <Link
                  href={learnHref("/learn/nestjs/associate")}
                  className="rounded-lg border-2 border-slate-300 bg-white px-8 py-3 text-base font-semibold text-slate-700 transition-all hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
                >
                  戻る
                </Link>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 sm:px-6 lg:px-8">
        <nav className="mb-8 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
          ...
          <span>/</span>
          <Link href={NESTJS_BASE} className="hover:text-slate-900 dark:hover:text-white transition-colors">
            NestJS
          </Link>
          <span>/</span>
          <Link href={NESTJS_ASSOCIATE} className="hover:text-slate-900 dark:hover:text-white transition-colors">
            Associate
          </Link>
          <span>/</span>
        ...
        <div className="rounded-2xl bg-white p-8 shadow-lg dark:bg-slate-800">
          <div className="mb-6 flex items-center gap-3">
            ...
            <EndStudyButton categoryId={categoryId} technology="nestjs" courseType="associate" />
          </div>
