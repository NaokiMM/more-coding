...
export default function TypeScriptIntroductionPage() {
  const lessons = [
    {
      id: 1,
      title: "TypeScriptとは何か",
      description: "TypeScriptの概要とJavaScriptとの違いについて学びます。",
      duration: "20分",
      completed: false,
    },
    {
      id: 2,
      title: "TypeScriptの特徴",
      description: "型安全性、コンパイル、IDEサポートなどの特徴を学びます。",
      duration: "25分",
      completed: false,
    },
    {
      id: 3,
      title: "開発環境のセットアップ",
      description: "TypeScriptの開発環境を構築する方法を学びます。",
      duration: "15分",
      completed: false,
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <nav className="mb-8 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
          ...
          <span>/</span>
          <span className="text-slate-900 dark:text-white">TypeScriptとは</span>
        </nav>

        {/* Page Header */}
        <div className="mb-8">
          <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 text-white text-2xl shadow-lg">
            📘
          </div>
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400">
            TypeScriptの概要と特徴、JavaScriptとの違いを学びます。
          </p>
        </div>
