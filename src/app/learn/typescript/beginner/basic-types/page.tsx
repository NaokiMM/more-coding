...
export default function TypeScriptBasicTypesPage() {
  const lessons = [
    {
      id: 1,
      title: "string型の使い方",
      description: "文字列型の基本的な使い方と型注釈を学びます。",
      duration: "25分",
    },
    {
      id: 2,
      title: "number型の使い方",
      description: "数値型の基本的な使い方と型注釈を学びます。",
      duration: "25分",
    },
    {
      id: 3,
      title: "boolean型の使い方",
      description: "真偽値型の基本的な使い方と型注釈を学びます。",
      duration: "20分",
    },
    {
      id: 4,
      title: "型注釈の実践",
      description: "実際のコードで型注釈を使う方法を学びます。",
      duration: "30分",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        <nav className="mb-8 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
          ...
          <span>/</span>
          <span className="text-slate-900 dark:text-white">型の基本</span>
        </nav>

        <div className="mb-8">
          <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-br from-green-500 to-green-600 text-white text-2xl shadow-lg">
            🔤
          </div>
          ...
          {lessons.map((lesson) => (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <button className="ml-4 rounded-lg bg-gradient-to-r from-green-500 to-green-600 px-4 py-2 text-sm font-semibold text-white shadow-lg transition-all hover:scale-105 hover:shadow-xl">
                  学習開始
                </button>
              </div>
            </div>
