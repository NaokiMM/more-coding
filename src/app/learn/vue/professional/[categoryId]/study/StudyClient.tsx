        ...
        <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="rounded-2xl bg-white p-8 shadow-lg dark:bg-slate-800">
            <div className="text-center">
              <div className="mb-6 flex justify-center">
                <div
                  className={`flex h-20 w-20 items-center justify-center rounded-xl bg-gradient-to-br ${category?.color || "from-green-500 to-emerald-600"} text-4xl shadow-lg`}
                >
                  {category?.icon || "📚"}
                </div>
              </div>
              ...
              <div className="flex justify-center gap-4">
                ...
                <Link
                  href={learnHref("/learn/vue/professional")}
                  className="rounded-lg border-2 border-slate-300 bg-white px-8 py-3 text-base font-semibold text-slate-700 transition-all hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
                >
                  戻る
                </Link>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 sm:px-6 lg:px-8">
        <nav className="mb-8 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
          ...
          <span>/</span>
          <Link href="/learn/vue" className="hover:text-slate-900 dark:hover:text-white transition-colors">
            Vue.js
          </Link>
          <span>/</span>
          <Link href="/learn/vue/professional" className="hover:text-slate-900 dark:hover:text-white transition-colors">
            Professional
          </Link>
          <span>/</span>
        ...
        <div className="rounded-2xl bg-white p-8 shadow-lg dark:bg-slate-800">
          <div className="mb-6 flex items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-green-500 to-emerald-600 text-lg font-bold text-white">
              {currentQuestionIndex + 1}
            </span>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white">
              問題 {currentQuestionIndex + 1} / {total}
            </h2>
            <EndStudyButton categoryId={categoryId} technology="vue" courseType="professional" />
          </div>
        ...
        <div className="mt-8 flex items-center justify-center gap-48">
          ...
          <button
            ...
            className="inline-flex items-center rounded-lg bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-3 text-base font-semibold text-white shadow-lg transition-all hover:scale-105 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
          >
