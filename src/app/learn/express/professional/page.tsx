/**
 * Express.js Professional カテゴリ一覧ページ
 *
 * ルート: /learn/express/professional
 */
...
export default function ExpressProfessionalPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <nav className="mb-8 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
          ...
          <span>/</span>
          <Link href="/learn/express" className="hover:text-slate-900 dark:hover:text-white transition-colors">
            Express.js
          </Link>
          <span>/</span>
        ...
        <div className="mb-12 text-center">
          <div className="mb-4 inline-flex h-20 w-20 items-center justify-center rounded-xl bg-gradient-to-br from-slate-500 to-gray-600 text-white text-3xl font-bold shadow-lg">
            📚
          </div>
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            より高度なExpress.jsの機能を学び、実践的なアプリケーション開発スキルを身につけます。
          </p>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <Link
              key={category.id}
              href={`/learn/express/professional/${category.id}/study`}
            ...
            >
              ...
              <div className="relative">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-800 dark:bg-slate-700 dark:text-slate-200">
                    Professional
                  </span>
                </div>
                ...
                <div className="mt-4 flex items-center text-sm font-semibold text-slate-600 dark:text-slate-400">
                  <span>学習を始める</span>
