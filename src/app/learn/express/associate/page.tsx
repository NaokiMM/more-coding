/**
 * Express Associate カテゴリ一覧ページ
 * 
 * ルート: /learn/express/associate
 * 
 * このページは、Express Associateレベルの学習カテゴリ一覧を表示します。
 * 各カテゴリ（例：ルーティング基礎、ミドルウェアなど）をクリックすると、そのカテゴリの学習ページに遷移します。
 */
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            Expressの基礎を学びます。ルーティング、ミドルウェア、リクエスト・レスポンス処理など基本的な概念から始めましょう。
          </p>
          {/* Membership Badges */}
