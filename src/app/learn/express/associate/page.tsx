/**
 * Express.js Associate カテゴリ一覧ページ
 *
 * ルート: /learn/express/associate
 *
 * このページは、Express.js Associateレベルの学習カテゴリ一覧を表示します。
...
export default function ExpressAssociatePage() {
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            Express.jsの基礎を学びます。<br />ルーティング、ミドルウェア、基本的なAPI構築などから始めましょう。
          </p>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <Link
              key={category.id}
              href={`/learn/express/associate/${category.id}/study`}
