/**
 * Django Associate カテゴリ一覧ページ
 * 
 * ルート: /learn/django/associate
 * 
 * このページは、Django Associateレベルの学習カテゴリ一覧を表示します。
 * 各カテゴリ（例：Djangoとは・概要・全体像、プロジェクトとアプリケーションなど）をクリックすると、そのカテゴリの学習ページに遷移します。
 */
...
export default function DjangoAssociatePage() {
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            Djangoの基礎を学びます。<br />プロジェクトの作成、モデル、ビュー、テンプレートなど基本的な概念をマスターしましょう。
          </p>
          {/* Membership Badges */}
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <Link
              key={category.id}
              href={`/learn/django/associate/${category.id}/study`}
