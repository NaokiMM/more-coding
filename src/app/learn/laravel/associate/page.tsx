/**
 * Laravel Associate カテゴリ一覧ページ
 * 
 * ルート: /learn/laravel/associate
 * 
 * このページは、Laravel Associateレベルの学習カテゴリ一覧を表示します。
 * 各カテゴリ（例：ルーティング・コントローラー、Eloquent ORMなど）をクリックすると、そのカテゴリの学習ページに遷移します。
 */
...
export default function LaravelAssociatePage() {
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            Laravelの基礎を学びます。ルーティング、Eloquent ORM、Bladeテンプレート、認証など基本的な概念から始めましょう。
          </p>
          {/* Membership Badges */}
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <Link
              key={category.id}
              href={`/learn/laravel/associate/${category.id}/study`}
