/**
 * Laravel Professional カテゴリ一覧ページ
 *
 * ルート: /learn/laravel/professional
 *
 * このページは、Laravel Professionalレベルの学習カテゴリ一覧を表示します。
...
export default function LaravelProfessionalPage() {
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            より高度なLaravelの機能を学びます。実践的なアプリケーション開発スキルをマスターしましょう。
          </p>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <Link
              key={category.id}
              href={`/learn/laravel/professional/${category.id}/study`}
