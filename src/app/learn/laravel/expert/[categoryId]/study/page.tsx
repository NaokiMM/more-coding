/**
 * Laravel Expert カテゴリ 学習ページ（サーバーコンポーネント）
 *
 * ルート: /learn/laravel/expert/[categoryId]/study
 *
 * 指定されたカテゴリIDの学習データ（問題集）をS3から取得し、
 * StudyClientに渡します。s3-assets/laravel/expert/jp/*.json に対応。
 */
...
export function generateStaticParams() {
  return laravelExpertCategoriesData.map((category) => ({
